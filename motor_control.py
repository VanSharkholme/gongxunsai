...
class XL330(Motor):
    def __init__(self, motor_id, robot_id=''):
        ...
        self.Max_Voltage = Parameter(32, 2, 'RW', 70, list(range(31, 71)))
        self.Min_Voltage = Parameter(34, 2, 'RW', 35, list(range(31, 71)))
        ...
        self.Profile_Accel = Parameter(108, 4, 'RW', 0, list(range(32768)))
        self.Profile_Velocity = Parameter(112, 4, 'RW', 0, list(range(32768)))
...
class XL430(Motor):
    def __init__(self, motor_id, robot_id=''):
        ...
        self.PROTOCOL_VERSION = 2.0
        self.type = 'XL430'
        self.Model_Num = Parameter(0, 2, 'R', 1060, None)
        self.Model_Info = Parameter(2, 4, 'R', None, None)
        self.Firmware_Version = Parameter(6, 1, 'R', None, None)
        # self.ID = Parameter(7, 1, 'RW', 1, list(range(253)), 1)
        self.Baud = Parameter(8, 1, 'RW', 1, list(range(7)))
        ...
        self.Moving_Threshold = Parameter(24, 4, 'RW', 10, list(range(1024)))
        self.Temp_Limit = Parameter(31, 1, 'RW', 70, list(range(101)))
        self.Max_Voltage = Parameter(32, 2, 'RW', 140, list(range(60, 141)))
        self.Min_Voltage = Parameter(34, 2, 'RW', 60, list(range(60, 141)))
        self.PWM_Limit = Parameter(36, 2, 'RW', 885, list(range(886)))
        self.Current_Limit = Parameter(38, 2, 'RW', 1750, list(range(1751)))
        self.Velocity_Limit = Parameter(44, 4, 'RW', 265, list(range(1024)))
        self.Max_Position_Limit = Parameter(48, 4, 'RW', 4095, list(range(4096)))
        self.Min_Position_Limit = Parameter(52, 4, 'RW', 0, list(range(4096)))
        self.Startup_Config = Parameter(60, 1, 'RW', 0, [0, 1, 2, 3])
        self.PWM_Slope = Parameter(62, 1, 'RW', 140, list(range(1, 256)))
        self.Shutdown = Parameter(63, 1, 'RW', 52, None)
        self.Torque_Ena = Parameter(64, 1, 'RW', 0, [0, 1])
        self.LED = Parameter(65, 1, 'RW', 0, [0, 1])
        self.Status_Return_Level = Parameter(68, 1, 'RW', 2, [0, 1, 2])
        self.Instruction_Registered = Parameter(69, 1, 'R', 0, [0, 1])
        self.Hardware_Error_Status = Parameter(70, 1, 'R', 0, None)
        self.Velocity_I_Gain = Parameter(76, 2, 'RW', 1000, list(range(16384)))
        self.Velocity_P_Gain = Parameter(78, 2, 'RW', 100, list(range(16384)))
        self.Position_D_Gain = Parameter(80, 2, 'RW', 4000, list(range(16384)))
        self.Position_I_Gain = Parameter(82, 2, 'RW', 0, list(range(16384)))
        self.Position_P_Gain = Parameter(84, 2, 'RW', 640, list(range(16384)))
        self.Feedforward_2nd_Gain = Parameter(88, 2, 'RW', 0, list(range(16384)))
        self.Feedforward_1st_Gain = Parameter(90, 2, 'RW', 0, list(range(16384)))
        self.Bus_Watchdog = Parameter(98, 1, 'RW', 0, list(range(1, 128)))
        self.Goal_PWM = Parameter(100, 2, 'RW', None, list(range(-885, 886)))
        # self.Goal_Current = Parameter(102, 2, 'RW', None, list(range(-1750, 1751)))
        self.Goal_Velocity = Parameter(104, 4, 'RW', None, list(range(-1023, 1024)))
        self.Profile_Accel = Parameter(108, 4, 'RW', 0, list(range(32768)))
        self.Profile_Velocity = Parameter(112, 4, 'RW', 0, list(range(32768)))
        self.Goal_Position = Parameter(116, 4, 'RW', None, list(range(4096)))
        self.Realtime_Tick = Parameter(120, 2, 'R', None, list(range(32768)))
        ...
        self.Present_Temp = Parameter(146, 1, 'R', None, list(range(101)))
        self.Backup_Ready = Parameter(147, 1, 'R', None, [0, 1])
        self.Indirect_Address1 = Parameter(168, 2, 'RW', 224, list(range(64, 228)))
        self.Indirect_Address2 = Parameter(170, 2, 'RW', 225, list(range(64, 228)))
        self.Indirect_Address3 = Parameter(172, 2, 'RW', 226, list(range(64, 228)))
        self.Indirect_Address4 = Parameter(174, 2, 'RW', 227, list(range(64, 228)))
        self.Indirect_Address5 = Parameter(176, 2, 'RW', 228, list(range(64, 228)))
        self.Indirect_Address6 = Parameter(178, 2, 'RW', 229, list(range(64, 228)))
        self.Indirect_Address7 = Parameter(180, 2, 'RW', 230, list(range(64, 228)))
        self.Indirect_Address8 = Parameter(182, 2, 'RW', 231, list(range(64, 228)))
        self.Indirect_Address9 = Parameter(184, 2, 'RW', 232, list(range(64, 228)))
        self.Indirect_Address10 = Parameter(186, 2, 'RW', 233, list(range(64, 228)))
        self.Indirect_Address11 = Parameter(188, 2, 'RW', 234, list(range(64, 228)))
        self.Indirect_Address12 = Parameter(190, 2, 'RW', 235, list(range(64, 228)))
        self.Indirect_Address13 = Parameter(192, 2, 'RW', 236, list(range(64, 228)))
        self.Indirect_Address14 = Parameter(194, 2, 'RW', 237, list(range(64, 228)))
        self.Indirect_Address15 = Parameter(196, 2, 'RW', 238, list(range(64, 228)))
        self.Indirect_Address16 = Parameter(198, 2, 'RW', 239, list(range(64, 228)))
        self.Indirect_Address17 = Parameter(200, 2, 'RW', 240, list(range(64, 228)))
        self.Indirect_Address18 = Parameter(202, 2, 'RW', 241, list(range(64, 228)))
        self.Indirect_Address19 = Parameter(204, 2, 'RW', 242, list(range(64, 228)))
        self.Indirect_Address20 = Parameter(206, 2, 'RW', 243, list(range(64, 228)))
        self.Indirect_Address21 = Parameter(208, 2, 'RW', 244, list(range(64, 228)))
        self.Indirect_Address22 = Parameter(210, 2, 'RW', 245, list(range(64, 228)))
        self.Indirect_Address23 = Parameter(212, 2, 'RW', 246, list(range(64, 228)))
        self.Indirect_Address24 = Parameter(214, 2, 'RW', 247, list(range(64, 228)))
        self.Indirect_Address25 = Parameter(216, 2, 'RW', 248, list(range(64, 228)))
        self.Indirect_Address26 = Parameter(218, 2, 'RW', 249, list(range(64, 228)))
        self.Indirect_Address27 = Parameter(220, 2, 'RW', 250, list(range(64, 228)))
        self.Indirect_Address28 = Parameter(222, 2, 'RW', 251, list(range(64, 228)))
        self.Indirect_Data1 = Parameter(224, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data2 = Parameter(225, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data3 = Parameter(226, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data4 = Parameter(227, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data5 = Parameter(228, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data6 = Parameter(229, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data7 = Parameter(230, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data8 = Parameter(231, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data9 = Parameter(232, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data10 = Parameter(233, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data11 = Parameter(234, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data12 = Parameter(235, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data13 = Parameter(236, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data14 = Parameter(237, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data15 = Parameter(238, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data16 = Parameter(239, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data17 = Parameter(240, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data18 = Parameter(241, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data19 = Parameter(242, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data20 = Parameter(243, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data21 = Parameter(244, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data22 = Parameter(245, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data23 = Parameter(246, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data24 = Parameter(247, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data25 = Parameter(248, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data26 = Parameter(249, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data27 = Parameter(250, 1, 'RW', 0, list(range(256)))
        self.Indirect_Data28 = Parameter(251, 1, 'RW', 0, list(range(256)))
        self.packetHandler = PacketHandler(self.PROTOCOL_VERSION)
